...
figure;
surf(X2+sphere_center(1),Y2+sphere_center(2),Z2+sphere_center(3),'FaceColor',[1 1 0],'FaceAlpha', 0.1)
...
title('Longitudinal Plane (NA = 1.1)');
ylabel('X (m)');
xlabel('Z (m)');
axis equal
ylim([-1.6 1.6]*R)
