...
%% Optical force calculation --> use OTGO --> NA = 0.7
...
% Focusing
f = 100e-6; % Focal length [m] --> ?
NA = 0.7; % numerical aperture --> water immersion objective
L = f*NA/nm; % Iris aperture [m]
...
title('Transverse Plane (NA = 0.70)');
xlabel('X (m)');
ylabel('Y (m)');
xlim([-1.6 1.6]*R)
ylim([-1.6 1.6]*R)
...
title('Longitudinal Plane (NA = 0.70)');
ylabel('X (m)');
xlabel('Z (m)');
axis equal
ylim([-1.6 1.6]*R)
...
%% Optical force calculation --> use OTGO --> NA = 1.0
...
% Focusing
f = 100e-6; % Focal length [m] --> ?
NA = 1.0; % numerical aperture --> water immersion objective
L = f*NA/nm; % Iris aperture [m]
...
% Transpose the 2D matrices (idk exactly why but this bug took me ages to solve)
quiver(X_tran',Y_tran',f_x_2D_tran,f_y_2D_tran,'LineWidth',2)
title('Transverse Plane (NA = 1.00)');
xlabel('X (m)');
ylabel('Y (m)');
xlim([-1.6 1.6]*R)
ylim([-1.6 1.6]*R)
...
% Transpose the 2D matrices (idk exactly why but this bug took me ages to solve)
quiver(Z_long',X_long',f_z_2D_long,f_x_2D_long,'LineWidth',2)
title('Longitudinal Plane (NA = 1.00)');
ylabel('X (m)');
xlabel('Z (m)');
axis equal
ylim([-1.6 1.6]*R)
...
%% Optical force calculation --> use OTGO --> NA = 1.20
...
% Transpose the 2D matrices (idk exactly why but this bug took me ages to solve)
quiver(X_tran',Y_tran',f_x_2D_tran,f_y_2D_tran,'LineWidth',2)
title('Transverse Plane (NA = 1.20)');
xlabel('X (m)');
ylabel('Y (m)');
xlim([-1.6 1.6]*R)
ylim([-1.6 1.6]*R)
...
% Transpose the 2D matrices (idk exactly why but this bug took me ages to solve)
quiver(Z_long',X_long',f_z_2D_long,f_x_2D_long,'LineWidth',2)
title('Longitudinal Plane (NA = 1.20)');
ylabel('X (m)');
xlabel('Z (m)');
axis equal
ylim([-1.6 1.6]*R)
