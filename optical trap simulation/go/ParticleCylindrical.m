classdef ParticleCylindrical < Particle
    ...
    methods
        ...
        function disp(bead)
            ...
            disp(['<a href="matlab:help ParticleCylindrical">ParticleCylindrical</a> (r=' num2str(bead.cyl.r) ', nm=' num2str(bead.nm) ', np=' num2str(bead.np) ') : x=' num2str(bead.cyl.c.X) ' y=' num2str(bead.cyl.c.Y) ' z=' num2str(bead.cyl.c.Z) ' Vx=' num2str(bead.cyl.c.Vx) ' Vy=' num2str(bead.cyl.c.Vy) ' Vz=' num2str(bead.cyl.c.Vz)]);
        end
